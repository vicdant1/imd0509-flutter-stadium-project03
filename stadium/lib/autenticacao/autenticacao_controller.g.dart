...
mixin _$AutenticacaoController on _AutenticacaoControllerBase, Store {
  ...
  @override
  Status get statusLogin {
    _$statusLoginAtom.reportRead();
    return super.statusLogin;
  }

  @override
  set statusLogin(Status value) {
    _$statusLoginAtom.reportWrite(value, super.statusLogin, () {
      super.statusLogin = value;
    });
  }

  late final _$statusCadastroAtom = Atom(
      name: '_AutenticacaoControllerBase.statusCadastro', context: context);

  @override
  Status get statusCadastro {
    _$statusCadastroAtom.reportRead();
    return super.statusCadastro;
  }

  @override
  set statusCadastro(Status value) {
    _$statusCadastroAtom.reportWrite(value, super.statusCadastro, () {
      super.statusCadastro = value;
    });
  }
